...
#介绍：
3大家都知道，虽然现在天翼云有活动送会员，但每次都要用客户端下载，比较麻烦，所以就做了这个东西。HTML单页，如果有GitHub pages，就可以上传上去，直接就能用，配合IDM直接满速下载（如果嫌麻烦可以直接使用我自己搭建的网页：https://tmp.feilongproject.com/189cloud.html）.
